...
import numpy as np
from src.models.gconv.garray.matrix_garray import MatrixGArray
from src.models.gconv.garray.finitegroup import FiniteGroup
from src.models.gconv.garray.p4_array import P4Array
from src.models.gconv.garray.Z2_array import Z2Array
...
class C4Group(FiniteGroup, C4Array):
    ...
    def __init__(self):
        C4Array.__init__(self, data=np.arange(4)[:, None], p='int')
